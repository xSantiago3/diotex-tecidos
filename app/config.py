...
class Settings(BaseSettings):
    ...
    order_confirmed_template_language: str = Field(default="en_US", alias="ORDER_CONFIRMED_TEMPLATE_LANGUAGE")
    ...
    pix_review_template_language: str = Field(default="en_US", alias="PIX_REVIEW_TEMPLATE_LANGUAGE")
