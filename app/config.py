...
class Settings(BaseSettings):
    ...
    order_separation_template_language: str = Field(default="pt_BR", alias="ORDER_SEPARATION_TEMPLATE_LANGUAGE")
    pix_awaiting_template_name: str = Field(default="pedido_aguardando_pix", alias="PIX_AWAITING_TEMPLATE_NAME")
    pix_awaiting_template_language: str = Field(default="pt_BR", alias="PIX_AWAITING_TEMPLATE_LANGUAGE")
    pix_review_template_name: str = Field(default="avaliar_pagamento_pix", alias="PIX_REVIEW_TEMPLATE_NAME")
    pix_review_template_language: str = Field(default="pt_BR", alias="PIX_REVIEW_TEMPLATE_LANGUAGE")
    # Templates de revisão por tipo de comprovante (uso opcional via flag)
    pix_review_media_templates_enabled: bool = Field(default=False, alias="PIX_REVIEW_MEDIA_TEMPLATES_ENABLED")
    pix_review_photo_template_name: str = Field(default="avaliar_pagamento_pix_foto", alias="PIX_REVIEW_PHOTO_TEMPLATE_NAME")
    pix_review_photo_template_language: str = Field(default="pt_BR", alias="PIX_REVIEW_PHOTO_TEMPLATE_LANGUAGE")
    pix_review_pdf_template_name: str = Field(default="avaliar_pagamento_pix_pdf", alias="PIX_REVIEW_PDF_TEMPLATE_NAME")
    pix_review_pdf_template_language: str = Field(default="pt_BR", alias="PIX_REVIEW_PDF_TEMPLATE_LANGUAGE")
